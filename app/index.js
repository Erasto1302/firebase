...
export default function Index() {
  ...
  return (
    ...
    >
      ...
      <Link href="/firebaseCRUD" asChild style={{ backgroundColor: "#FF3737", padding: 15, borderRadius: 10, width: '95%', marginBottom: 10 }}>
        <Pressable>
          <Text style={{ fontSize: 22, color: "#FFFFFF", textAlign: "center" }}> FIREBASE CRUD </Text>
        </Pressable>
      </Link>

      <Link href="/notification" asChild style={{ backgroundColor: "#FF3737", padding: 15, borderRadius: 10, width: '95%', marginBottom: 10 }}>
        <Pressable>
          <Text style={{ fontSize: 22, color: "#FFFFFF", textAlign: "center" }}> NOTIFICATION </Text>
        </Pressable>
      </Link>

      <Link href="/contacto" asChild style={{ backgroundColor: "#FF3737", padding: 15, borderRadius: 10, width: '95%', marginBottom: 10 }}>
        <Pressable>
          <Text style={{ fontSize: 22, color: "#FFFFFF", textAlign: "center" }}> CONTATOS </Text>
        </Pressable>
      </Link>
